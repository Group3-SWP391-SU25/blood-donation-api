...
namespace BloodDonation.Application.Services.Interfaces
{
    public interface IBloodStorageService
    {
        ...
        Task<object> GetAvailableBloods(int pageIndex, int pageSize, Guid? EmergencyBloodRequestId = null, BloodStorageStatusEnum? status = null, int? volume = null, CancellationToken cancellationToken = default);
