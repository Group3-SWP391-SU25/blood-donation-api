...
namespace BloodDonation.Infrastructures.Migrations
{
    ...
    [Migration("20250606134324_V0.2_ModifyUsersFields")]
    partial class V02_ModifyUsersFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BloodDonation.Domain.Entities.BloodComponent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 6, 6, 20, 43, 23, 64, DateTimeKind.Local).AddTicks(3505),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 6, 20, 43, 23, 64, DateTimeKind.Local).AddTicks(3507),
                            IsDeleted = false,
                            Name = "Plasma",
                            ShelfLifeInDay = 0,
                            Status = "",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 6, 20, 43, 23, 64, DateTimeKind.Local).AddTicks(3508),
                            IsDeleted = false,
                            Name = "Platelets",
                            ShelfLifeInDay = 0,
                            Status = "",
            ...
            modelBuilder.Entity("BloodDonation.Domain.Entities.BloodGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 6, 20, 43, 23, 64, DateTimeKind.Local).AddTicks(3416),
                            IsDeleted = false,
                            Type = "A"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 6, 20, 43, 23, 64, DateTimeKind.Local).AddTicks(3419),
                            IsDeleted = false,
                            Type = "B"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 6, 20, 43, 23, 64, DateTimeKind.Local).AddTicks(3420),
                            IsDeleted = false,
                            Type = "O"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 6, 20, 43, 23, 64, DateTimeKind.Local).AddTicks(3422),
                            IsDeleted = false,
                            Type = "AB"
                        });
                });
            ...
            modelBuilder.Entity("BloodDonation.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 6, 20, 43, 23, 64, DateTimeKind.Local).AddTicks(3197),
                            IsDeleted = false,
                            Name = "ADMIN"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 6, 20, 43, 23, 64, DateTimeKind.Local).AddTicks(3219),
                            IsDeleted = false,
                            Name = "MEMBER"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 6, 20, 43, 23, 64, DateTimeKind.Local).AddTicks(3222),
                            IsDeleted = false,
                            Name = "NURSE"
                        });
                });
