...
namespace BloodDonation.Infrastructures.Migrations
{
    ...
    [Migration("20250609173018_V0_3_ModifyDb")]
    partial class V0_3_ModifyDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BloodDonation.Domain.Entities.BloodComponent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 6, 10, 0, 30, 17, 51, DateTimeKind.Local).AddTicks(4371),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 10, 0, 30, 17, 51, DateTimeKind.Local).AddTicks(4374),
                            IsDeleted = false,
                            Name = "Plasma",
                            ShelfLifeInDay = 0,
                            Status = "",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 10, 0, 30, 17, 51, DateTimeKind.Local).AddTicks(4375),
                            IsDeleted = false,
                            Name = "Platelets",
                            ShelfLifeInDay = 0,
                            Status = "",
            ...
            modelBuilder.Entity("BloodDonation.Domain.Entities.BloodGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 10, 0, 30, 17, 51, DateTimeKind.Local).AddTicks(4334),
                            IsDeleted = false,
                            Type = "A"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 10, 0, 30, 17, 51, DateTimeKind.Local).AddTicks(4339),
                            IsDeleted = false,
                            Type = "B"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 10, 0, 30, 17, 51, DateTimeKind.Local).AddTicks(4340),
                            IsDeleted = false,
                            Type = "O"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 10, 0, 30, 17, 51, DateTimeKind.Local).AddTicks(4342),
                            IsDeleted = false,
                            Type = "AB"
                        });
                });
            ...
            modelBuilder.Entity("BloodDonation.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 10, 0, 30, 17, 51, DateTimeKind.Local).AddTicks(4080),
                            IsDeleted = false,
                            Name = "ADMIN"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 10, 0, 30, 17, 51, DateTimeKind.Local).AddTicks(4107),
                            IsDeleted = false,
                            Name = "MEMBER"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 6, 10, 0, 30, 17, 51, DateTimeKind.Local).AddTicks(4111),
                            IsDeleted = false,
                            Name = "NURSE"
                        });
                });
