...
namespace BloodDonation.Infrastructures.Migrations
{
    ...
    [Migration("20250527151229_V0.1_modified_fields")]
    partial class V01_modified_fields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BloodDonation.Domain.Entities.BloodComponent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 5, 27, 22, 12, 28, 150, DateTimeKind.Local).AddTicks(3629),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 5, 27, 22, 12, 28, 150, DateTimeKind.Local).AddTicks(3633),
                            IsDeleted = false,
                            Name = "Plasma",
                            ShelfLifeInDay = 0,
                            Status = "",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 5, 27, 22, 12, 28, 150, DateTimeKind.Local).AddTicks(3636),
                            IsDeleted = false,
                            Name = "Platelets",
                            ShelfLifeInDay = 0,
                            Status = "",
            ...
            modelBuilder.Entity("BloodDonation.Domain.Entities.BloodGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 5, 27, 22, 12, 28, 150, DateTimeKind.Local).AddTicks(3541),
                            IsDeleted = false,
                            Type = "A"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 5, 27, 22, 12, 28, 150, DateTimeKind.Local).AddTicks(3552),
                            IsDeleted = false,
                            Type = "B"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 5, 27, 22, 12, 28, 150, DateTimeKind.Local).AddTicks(3556),
                            IsDeleted = false,
                            Type = "O"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 5, 27, 22, 12, 28, 150, DateTimeKind.Local).AddTicks(3559),
                            IsDeleted = false,
                            Type = "AB"
                        });
                });
            ...
            modelBuilder.Entity("BloodDonation.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 5, 27, 22, 12, 28, 150, DateTimeKind.Local).AddTicks(3152),
                            IsDeleted = false,
                            Name = "ADMIN"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 5, 27, 22, 12, 28, 150, DateTimeKind.Local).AddTicks(3193),
                            IsDeleted = false,
                            Name = "MEMBER"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 5, 27, 22, 12, 28, 150, DateTimeKind.Local).AddTicks(3196),
                            IsDeleted = false,
                            Name = "NURSE"
                        });
                });
